...
// Slogan Animation (Completes before 5s)
setTimeout(() => {
    const slogan = document.getElementById("slogan");
    slogan.style.transition = "all 1s cubic-bezier(0.25, 0.8, 0.25, 1)";
...
setTimeout(() => {
    ...
    energy.animate(
        [
            { height: "0px" },
            { height: "480px" } // Adjusted slightly for new height
        ],
        {
            duration: 1200,
            fill: "forwards",
